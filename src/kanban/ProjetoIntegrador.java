...
private static boolean validarDataTermino(String dataInicio, String dataTermino) {
    ...
    try {
        ...
        Acao acao = new Acao(nomeAcao, descricaoAcao, dataInicioAcao, dataTerminoAcao,
                areaResponsavelAcao, usuarioResponsavelAcao, percentConclusaoAcao, statusEnum, null);
